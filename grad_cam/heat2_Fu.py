...
if __name__ == '__main__':
    ...
    # load image
        ...
        path_net = os.path.join("H:/Bayer/bbox_ing/aug_model/weights/1_5_fusion_3P.pth") # in this example not use

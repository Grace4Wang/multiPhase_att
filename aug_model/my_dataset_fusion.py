...
class MyDataSet(Dataset):
    ...
    def __init__(self, data_dir1, data_dir2, data_dir3, txt):
    ...
    def __getitem__(self, index):
        ...
        image_path3 = os.path.join(self.data_dir3, fn)
        img3 = SimpleITK.ReadImage(image_path3)
        img3 = SimpleITK.GetArrayFromImage(img3)
        img3 = np.array(img3, dtype='float32')
        image3 = img3[np.newaxis, :]
    ...
    def collate_fn(batch):
        ...
        images1,images2,images3, labels = tuple(zip(*batch))
        ...
        return images1,images2,images3, labels
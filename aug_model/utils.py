...
def evaluate(model, data_loader, device):
    ...
    # model_3D = medcam.inject(model, output_dir='E:/Bayer/data/figures/AP_try', save_maps=True)
    ...
    for step, data in enumerate(data_loader):
        ...
        # batch1 = images1
        # batch1 = batch1[None, :, :, :, :]
        # batch1 = np.expand_dims(batch1, 1)  # if numpy array
    ...
    return val_loss, val_acc, fpr, tpr, AUC,confu_matrix,sensitivity,specificity,val_trues,val_preds,val_midpre
